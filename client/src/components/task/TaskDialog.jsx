              ...
              <div className='px-1 py-1 space-y-2'>
                {items.map((el) => (
                  <MenuItem key={el.label}>
                      ...
                      <button
                        onClick={el?.onClick}
                        className= "group flex w-full items-center rounded-md px-2 py-2 text-sm text-gray-900 hover:bg-blue-500 hover:text-white focus:bg-blue-500 focus:text-white"
                      >
                        {el.icon}
                        {el.label}
                      </button>
